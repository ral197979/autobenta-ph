    ...
    <section className="py-16 bg-softbg">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <p className="text-xs font-semibold uppercase tracking-wider text-deepblue mb-2">ROI Calculator</p>
          <h2 className="text-2xl font-bold text-ink sm:text-3xl">See your potential return</h2>
          <p className="text-sm text-slatetext mt-2">Adjust the sliders to match your dealership.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-cardborder p-6 sm:p-8">
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              <div>
                <div className="flex justify-between mb-2">
                  <label className="text-sm font-semibold text-ink">Vehicles sold / month</label>
                  <span className="text-sm font-bold text-deepblue">{vehiclesSold}</span>
                </div>
                <input
                  type="range"
                  min={1}
                ...
                />
                <div className="flex justify-between text-xs text-slatetext mt-1"><span>1</span><span>50</span></div>
              </div>

              <div>
                <label className="block text-sm font-semibold text-ink mb-2">Avg gross profit per vehicle</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm font-semibold text-slatetext">₱</span>
                  <input
                    type="number"
                    min={0}
                    step={5000}
                    ...
                    className="w-full rounded-lg border border-cardborder pl-8 pr-4 py-2.5 text-sm text-ink focus:outline-none focus:ring-2 focus:ring-deepblue/30"
                  />
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <label className="text-sm font-semibold text-ink">Current lead conversion rate</label>
                  <span className="text-sm font-bold text-deepblue">{conversionRate}%</span>
                </div>
                <input
                  type="range"
                  min={1}
                  ...
                  className="w-full accent-deepblue"
                />
                <div className="flex justify-between text-xs text-slatetext mt-1"><span>1%</span><span>30%</span></div>
              </div>
            ...
            <div className="flex flex-col gap-4 justify-center">
              <div className="rounded-2xl bg-deepblue/5 border border-deepblue/20 p-6 text-center">
                <p className="text-xs font-semibold uppercase tracking-wider text-deepblue mb-1">Monthly Revenue Uplift</p>
                <p className="text-4xl font-bold text-deepblue">{formatPeso(revenueUplift)}</p>
              </div>
              <div className={`rounded-2xl border p-6 text-center ${roi >= 0 ? 'bg-emerald-50 border-emerald-200' : 'bg-red-50 border-red-200'}`}>
                <p className="text-xs font-semibold uppercase tracking-wider text-slatetext mb-1">ROI on Platform Cost</p>
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-deepblue px-6 py-3 text-sm font-bold text-white hover:bg-deepblue/90 transition-colors"
              >
    ...
    <div className="bg-white">
      ...
      <section className="py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <p className="text-xs font-semibold uppercase tracking-wider text-deepblue mb-2">The Problem</p>
            <h2 className="text-2xl font-bold text-ink sm:text-3xl">The Problem with Selling Cars Today</h2>
          </div>
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={title} className="rounded-2xl border border-cardborder p-6 flex flex-col gap-3">
      ...
      <section className="py-16 bg-softbg">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <p className="text-xs font-semibold uppercase tracking-wider text-deepblue mb-2">The Solution</p>
            <h2 className="text-2xl font-bold text-ink sm:text-3xl">AutoBentaPH Dealer Platform</h2>
            <p className="text-sm text-slatetext mt-2">Four pillars that replace five separate tools.</p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {PILLARS.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="rounded-2xl border border-cardborder bg-white p-5 flex flex-col gap-3">
                <div className="h-10 w-10 rounded-xl bg-deepblue/10 flex items-center justify-center">
          ...
          <div className="grid grid-cols-3 gap-4">
            {STATS.map(({ value, label }) => (
              <div key={label} className="text-center">
                ...
                <p className="text-xs text-slatetext mt-1">{label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-2 items-center">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-deepblue mb-2">Lead CRM</p>
              <h2 className="text-2xl font-bold text-ink sm:text-3xl mb-4">Your entire pipeline, one screen</h2>
              <p className="text-sm text-slatetext leading-relaxed mb-6">
            ...
            <div className="rounded-2xl border-2 border-dashed border-cardborder bg-softbg flex items-center justify-center h-56 sm:h-72">
              <div className="text-center">
                <Layers className="h-10 w-10 text-slatetext/40 mx-auto mb-2" />
                <p className="text-sm font-semibold text-slatetext/60">Kanban CRM</p>
                <p className="text-xs text-slatetext/40">8-stage pipeline preview</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-softbg">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <p className="text-xs font-semibold uppercase tracking-wider text-deepblue mb-2">Lead Management</p>
            <h2 className="text-2xl font-bold text-ink sm:text-3xl">Respond faster. Close more.</h2>
          </div>
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              {
              ...
              <div key={title} className="rounded-2xl border border-cardborder bg-white p-5 flex gap-4">
      ...
      <section className="py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-2 items-center">
            <div className="order-2 lg:order-1 rounded-2xl border-2 border-dashed border-cardborder bg-softbg flex items-center justify-center h-56 sm:h-72">
              <div className="text-center">
                <RefreshCw className="h-10 w-10 text-slatetext/40 mx-auto mb-2" />
                <p className="text-sm font-semibold text-slatetext/60">V8Atlas Sync</p>
                <p className="text-xs text-slatetext/40">Live inventory pipeline</p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <p className="text-xs font-semibold uppercase tracking-wider text-deepblue mb-2">Inventory Sync</p>
              <h2 className="text-2xl font-bold text-ink sm:text-3xl mb-4">Never type a listing twice</h2>
              <p className="text-sm text-slatetext leading-relaxed mb-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 max-w-2xl mx-auto">
            {PLANS.map((plan) => (
              ...
              >
                ...
                <p className="text-sm font-bold text-ink mb-1">{plan.name}</p>
                <div className="flex items-end gap-0.5 mb-1">
                  <p className="text-2xl font-bold text-deepblue">{plan.price}</p>
                  {plan.period && <p className="text-xs text-slatetext mb-1">{plan.period}</p>}
                </div>
                <p className="text-xs text-slatetext mb-4">{plan.desc}</p>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-gradient-to-br from-ink to-deepblue text-white p-8 sm:p-10">
            <div className="grid gap-8 lg:grid-cols-2 items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-semibold text-white/80 mb-4">
